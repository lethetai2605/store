...
class ItemReviewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create item_review" do
    assert_difference('ItemReview.count') do
      post item_reviews_url, params: { item_review: { item_id: @item_review.item_id, review: @item_review.review, user_id: @item_review.user_id } }
    end
  ...
  test "should update item_review" do
    patch item_review_url(@item_review), params: { item_review: { item_id: @item_review.item_id, review: @item_review.review, user_id: @item_review.user_id } }
